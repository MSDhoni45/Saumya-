      ...
      <header className="shrink-0 border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <nav className="flex items-center gap-4 text-sm">
            ...
            <a href="/x" className="font-medium text-slate-700 hover:text-brand-600">
              X / Twitter
            </a>
            <a href="/analytics" className="font-medium text-slate-700 hover:text-brand-600">
              Analytics
            </a>
            <a href="/settings/billing" className="font-medium text-slate-700 hover:text-brand-600">
              Billing
            </a>
            <a href="/settings/team" className="font-medium text-slate-700 hover:text-brand-600">
              Team
            </a>
